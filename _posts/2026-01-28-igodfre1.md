...
I'm visualizing quantitative data. There is quantitative data that represents the x,y position of a spatial location within the tissue sample, and also quantitative data that represents the gene expression count that shows how many RNA transcripts of each gene were detected in that position. I specifically used the genes Umod and Cyp4b1 and used the quantitative data of the gene expression count. 
